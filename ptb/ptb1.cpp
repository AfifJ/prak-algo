    ...
    if (value < t->data) {
      ...
      if (t->left == NULL && t->right == NULL) {
        ...
        return NULL;
                 ...
                 NULL) { // if left tree is null, set t to it's right tree
        t = t->right;
      } else if (t->right ==
                 NULL) { // if right tree is null, set t to it's left tree
        t = t->left;
      } else {
...
// time complexity is always O(n). aaverage space complexity is O(n) for worst
// case.
